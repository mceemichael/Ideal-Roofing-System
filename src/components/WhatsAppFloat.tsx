...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-whatsapp px-4 py-3 text-sm font-semibold text-white shadow-float transition-transform hover:scale-105 focus:outline-none focus-visible:ring-4 focus-visible:ring-whatsapp/40"
    >
      <svg
        viewBox="0 0 24 24"
        aria-hidden="true"
